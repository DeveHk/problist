...
export default function SideNav() {
    return (
        <div className="sticky top-0  z-30 flex min-h-screen bg-red-950 w-full flex-col">
            <Nav />
            <aside className="z-10 flex-1 hidden w-10 flex-col border-r bg-background sm:flex">
